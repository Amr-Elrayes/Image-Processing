...
class ThreeLevelThresholding extends StatelessWidget {
  final File imageFile;

  const ThreeLevelThresholding({super.key, required this.imageFile});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Three Level Thresholding"),
        centerTitle: true,
      ),
      backgroundColor: Colors.white,
      body: Column(
