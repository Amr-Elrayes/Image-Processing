...
class OtsuMultipleThresholding extends StatelessWidget {
  final File imageFile;

  const OtsuMultipleThresholding({super.key, required this.imageFile});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Otsu Multiple Thresholding"),
        centerTitle: true,
      ),
      backgroundColor: Colors.white,
      body: Column(
